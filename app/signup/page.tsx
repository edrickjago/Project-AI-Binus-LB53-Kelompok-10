    ...
    <div className="auth-root">
      ...
      <div className="auth-card auth-card-wide">
        ...
        <button 
          ...
          disabled={loading || googleLoading}
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', background: 'var(--surface)', color: 'var(--text-primary)', border: '1px solid var(--border)' }}
        >
          {googleLoading ? <span className="auth-spinner" style={{ width: 18, height: 18, borderWidth: 2 }} /> : (
            <>
